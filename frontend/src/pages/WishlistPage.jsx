...
const WishlistPage = () => {
            ...
            <div className='mx-auto max-w-6xl px-6'>
                ...
                <header className="mb-12 border-b border-neutral-100 pb-8">
                    ...
                    <div className="flex items-baseline justify-between">
                        <h1 className='text-3xl md:text-4xl font-light tracking-tight t
                        ext-neutral-900 font-serif lowercase first-letter:uppercase'>
                            My Wishlist
                        </h1>
    ...
    const EmptyWishlistUI = () => (
        ...
        bg-neutral-50/30 rounded-[32px] border border-dashed border-neutral-100'>
            ...
            <p className='text-neutral-500 text-[10px] mt-2 mb-8 tracking-wide font-light 
            max-w-[200px] mx-auto leading-relaxed'>
                Save your favorite beauty essentials here for your future rituals.
            </p>
            <Link
                className='inline-block bg-[#74090A] text-white px-10 py-3 rounded-full 
                text-[9px] font-bold uppercase tracking-[0.2em] hover:bg-black transition-all duration-500'
                to='/category'
            >
                Discover products
            </Link>
