    ...
    useEffect(() => {
        ...
        const handleCheckoutSuccess = async (id) => {
            ...
            try {
                ...
                setError("Failed to verify your purchase. If you paid, please contact support with your session ID.");
            } finally {
        ...
        if (sessionId) {
            ...
            setIsProcessing(false);
            setError("No session ID found. Your payment might not have been completed.");
        }
    }, [clearCart]);
        ...
        return (
            <div className='h-screen flex items-center justify-center bg-white'>
                <div className="text-center">
                    ...
                    <p className="text-[11px] uppercase tracking-widest text-neutral-400 font-bold">Verifying payment...</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className='h-screen flex items-center justify-center bg-white px-4'>
                <div className="max-w-md w-full text-center p-8 border border-neutral-100 rounded-[20px] shadow-sm">
                    <p className="text-[#74090A] font-bold uppercase text-[10px] tracking-widest mb-2">Notice</p>
                    <p className="text-neutral-600 text-sm mb-6">{error}</p>
                    <Link to="/" className="inline-block text-[10px] font-bold 
                    uppercase tracking-widest border-b border-[#74090A] pb-1 text-[#74090A]">
                        Back to Store
                    </Link>
                </div>
            </div>
            ...
            >
                <div className='p-8 sm:p-10 text-center'>
                    ...
                    <p className='text-neutral-500 text-sm font-light mb-8 px-4'>
                        Thank you for your choice. We have received your payment and are already preparing your BeautyUp products.
                    </p>
                    ...
                    <Link
                        to={"/catalog"}
                        className='w-full bg-[#74090A] hover:bg-[#4F0608] text-white text-[10px] font-bold 
                        uppercase tracking-widest py-4 px-4 rounded-xl transition duration-300 flex items-center 
                        justify-center shadow-sm active:scale-[0.98]'
                    >
