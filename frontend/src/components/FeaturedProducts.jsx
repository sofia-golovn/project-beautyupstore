        ...
        <section className='py-12 md:py-20 bg-white relative overflow-visible'>
            <div className='container mx-auto px-4 md:px-6 relative z-10'>
                ...
                <div className='flex flex-col items-center justify-center mb-10 md:mb-16'>
                    <h2 className='font-["Playfair_Display"] text-3xl md:text-5xl uppercase tracking-[0.2em] text-black font-light'>
                        Our
                    </h2>
                    <p className='font-sans text-[10px] md:text-[12px] uppercase tracking-[0.6em] text-[#74090A] font-medium mt-2'>
                        Bestsellers
                    </p>
                </div>
                ...
                <div className='relative group/slider'>
                    <div 
                        className='overflow-hidden rounded-[20px] md:rounded-[40px]'
                    ...
                    >
                        ...
                        >
                            {featuredProducts?.map((product) => (
                                <div key={product._id} className='w-1/2 lg:w-1/3 xl:w-1/4 flex-shrink-0 px-1.5 md:px-4'>
                                    <div 
                                        onClick={(e) => openModal(e, product)} 
                                        className='group block cursor-pointer'
                                    >
                                        <div className='relative aspect-[3/4] overflow-hidden rounded-[20px] md:rounded-[40px] mb-4 md:mb-6'>
                                            <img
                                                src={product.image}
                                                alt={product.name}
                                        ...
                                        <div className='text-center px-1 md:px-2'>
                                            <h3 className='font-["Playfair_Display"] text-sm md:text-lg text-black capitalize tracking-wide mb-1 line-clamp-1'>
                                                {product.name}
                                            </h3>
                                            <p className='text-[#74090A] font-montserrat text-xs md:text-sm tracking-widest opacity-80'>
