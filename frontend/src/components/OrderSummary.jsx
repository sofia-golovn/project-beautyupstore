        ...
        >
            ...
            <div className='space-y-4'>
                ...
                <div className="pt-4 space-y-4">
                    <motion.button
                        className="flex w-full items-center justify-center rounded-lg bg-[#74090A] px-8 py-3.5 text-[9px] font-bold uppercase tracking-widest text-white hover:bg-[#4F0608] transition-all duration-300 shadow-sm active:scale-[0.98] focus:outline-none"
                    ...
                    <div className='flex items-center justify-center gap-3'>
                        ...
                        <Link
                            to="/"
                            className="inline-flex items-center gap-2 text-[9px] font-bold uppercase tracking-[0.2em] text-neutral-900 hover:text-[#74090A] transition-colors"
                        >
                            Continue Shopping
                            <MoveRight size={14} />
                        </Link>
