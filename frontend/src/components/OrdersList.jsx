...
const OrdersList = ({ onFilterChange }) => {
    ...
    if (loading) return (
        <div className="text-center py-20 text-[10px] uppercase tracking-widest text-neutral-300">
            Loading...
        </div>
    );
                            ...
                            {orders.length > 0 ? (
                                orders.map((order) => (
                                    <tr key={order._id} className="hover:bg-gray-50 transition-colors">
                                        <td className="px-6 py-4 align-top whitespace-nowrap sm:whitespace-normal">
                                ...
                                <tr>
                                    <td colSpan="4" className="py-20 text-center text-neutral-300 text-xs font-light italic">
